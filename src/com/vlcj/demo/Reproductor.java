...
public class Reproductor extends javax.swing.JFrame {
    ...
    private File file;
    static{
        //NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcLibraryName(), "C:\\Program Files (x86)\\VideoLAN\\VL");
    ...
    public Reproductor() {
        ...
        btnPlay.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
               player.getMediaPlayer().playMedia("http://192.168.1.71:8080/video"); 
                if (file!=null){                    
